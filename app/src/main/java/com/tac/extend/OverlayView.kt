...
class OverlayView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (line in lines) {
            val scoring = isScoringLine(line)
            ...
            if (scoring) {
                ...
                canvas.drawCircle(
                    line.nearestPocket.x,
                    line.nearestPocket.y,
                    22f,
                    pocketHighlight
                )
    ...
    private fun isScoringLine(line: DetectedLine): Boolean {
        val dx = line.extended.x - line.nearestPocket.x
        val dy = line.extended.y - line.nearestPocket.y
