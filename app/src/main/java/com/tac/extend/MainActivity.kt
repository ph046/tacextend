    ...
    private fun checkStart() {
        if (!Settings.canDrawOverlays(this)) {
            startActivityForResult(Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
                Uri.parse("package:$packageName")), 1002)
            return
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            ...
            1001 -> if (resultCode == Activity.RESULT_OK && data != null) {
                val i = Intent(this, ExtendService::class.java).apply {
                ...
                Toast.makeText(this, "Mire a bola e toque Escanear!", Toast.LENGTH_LONG).show()
                moveTaskToBack(true)
            }
        }
    }
